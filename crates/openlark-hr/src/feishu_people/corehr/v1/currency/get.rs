...
impl GetRequest {
    ...
    pub async fn execute_with_options(
        ...
        Transport::request_typed(request, &self.config, Some(option), "查询货币响应数据为空").await
    }
}
...
mod tests {
    ...
    /// 端到端：GET /open-apis/corehr/v1/currencies/test001
    #[tokio::test]
    async fn test_get_returns_data_on_success() {
        let server = MockServer::start().await;
        Mock::given(method("GET"))
            .and(path("/open-apis/corehr/v1/currencies/test001"))
