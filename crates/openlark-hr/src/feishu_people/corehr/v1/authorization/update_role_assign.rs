...
mod tests {
    ...
    /// 端到端：POST /open-apis/corehr/v1/authorizations/update_role_assign
    #[tokio::test]
    async fn test_update_role_assign_returns_data_on_success() {
        ...
        UpdateRoleAssignRequest::new(config)
            .execute()
            .await
            .expect("请求应成功");
