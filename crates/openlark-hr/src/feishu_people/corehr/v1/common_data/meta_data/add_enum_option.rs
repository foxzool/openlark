...
mod tests {
    ...
    /// 端到端：POST /open-apis/corehr/v1/common_data/meta_data/add_enum_option
    #[tokio::test]
    async fn test_add_enum_option_returns_data_on_success() {
        ...
        AddEnumOptionRequest::new(config)
            .execute()
            .await
            .expect("请求应成功");
