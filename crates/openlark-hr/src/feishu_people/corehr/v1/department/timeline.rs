...
mod tests {
    ...
    /// 端到端：POST /open-apis/corehr/v1/departments/query_timeline
    #[tokio::test]
    async fn test_timeline_returns_data_on_success() {
        let server = MockServer::start().await;
        Mock::given(method("POST"))
            .and(path("/open-apis/corehr/v1/departments/query_timeline"))
