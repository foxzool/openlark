...
mod tests {
    ...
    /// 端到端：POST /open-apis/corehr/v2/probation/enable_disable_assessment
    #[tokio::test]
    async fn test_enable_disable_assessment_returns_data_on_success() {
        ...
        EnableDisableAssessmentRequest::new(config)
            .execute()
            .await
            .expect("请求应成功");
