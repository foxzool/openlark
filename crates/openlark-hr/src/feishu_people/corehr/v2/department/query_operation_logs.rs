...
mod tests {
    ...
    /// 端到端：POST /open-apis/corehr/v2/departments/query_operation_logs
    #[tokio::test]
    async fn test_query_operation_logs_returns_data_on_success() {
        ...
        QueryOperationLogsRequestBuilder::new(config)
            .execute()
            .await
            .expect("请求应成功");
