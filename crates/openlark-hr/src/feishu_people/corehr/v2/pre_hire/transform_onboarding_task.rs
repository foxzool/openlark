...
mod tests {
    ...
    /// 端到端：POST /open-apis/corehr/v2/pre_hires/transform_onboarding_task
    #[tokio::test]
    async fn test_transform_onboarding_task_returns_data_on_success() {
        ...
        TransformOnboardingTaskRequest::new(config)
            .execute()
            .await
            .expect("请求应成功");
