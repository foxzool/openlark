...
mod tests {
    ...
    /// 端到端：POST /open-apis/corehr/v2/pre_hires/test001/complete
    #[tokio::test]
    async fn test_complete_returns_data_on_success() {
        let server = MockServer::start().await;
        Mock::given(method("POST"))
            .and(path("/open-apis/corehr/v2/pre_hires/test001/complete"))
