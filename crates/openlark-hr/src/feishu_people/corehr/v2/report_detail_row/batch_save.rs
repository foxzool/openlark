...
mod tests {
    ...
    /// 端到端：POST /open-apis/corehr/v2/report_detail_row/batchSave
    #[tokio::test]
    async fn test_batchsave_returns_data_on_success() {
        let server = MockServer::start().await;
        Mock::given(method("POST"))
            .and(path("/open-apis/corehr/v2/report_detail_row/batchSave"))
