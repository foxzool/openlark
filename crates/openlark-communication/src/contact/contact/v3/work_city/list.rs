...
mod tests {
    ...
    /// 端到端：GET /open-apis/contact/v3/work_cities
    #[tokio::test]
    async fn test_list_work_cities_returns_data_on_success() {
        let server = MockServer::start().await;
        Mock::given(method("GET"))
            .and(path("/open-apis/contact/v3/work_cities"))
        ...
        ListWorkCitiesRequest::new(config)
            .execute()
            .await
            .expect("请求应成功");
