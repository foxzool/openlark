//! 获取指定会话信息
//!
//! docPath: <https://open.feishu.cn/document/server-docs/aily-v1/agent-agent_chat_session/get>
...
/// 获取指定会话信息请求。
#[derive(Debug, Clone)]
pub struct GetAgentChatSessionRequest {
    config: Arc<Config>,
    agent_id: String,
    agent_chat_session_id: String,
}

impl GetAgentChatSessionRequest {
    /// 创建新的请求构建器。
    ...
    pub async fn execute_with_options(self, option: RequestOption) -> SDKResult<serde_json::Value> {
        ...
        Transport::request_typed(req, &self.config, Some(option), "获取指定会话信息").await
    }
}
...
mod tests {
    ...
    fn builder_sets_params() {
        ...
        let request = GetAgentChatSessionRequest::new(config)
            .agent_id("agent_123")
    ...
    #[test]
    fn test_get_agent_chat_session_request_url_construction() {
