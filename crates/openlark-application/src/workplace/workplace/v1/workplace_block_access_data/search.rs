...
//! docPath: <https://open.feishu.cn/document/workplace-v1/workplace_access_data/search-2>
...
#[derive(Debug, Clone)]
pub struct AccessDataSearchBlockRequestBuilder {
    config: Config,
    start_date: String,
    end_date: String,
}

impl AccessDataSearchBlockRequestBuilder {
    /// 创建新的 Builder
