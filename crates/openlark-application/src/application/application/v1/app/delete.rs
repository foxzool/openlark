...
impl DeleteAppRequest {
    ...
    /// 待补充文档。
    pub async fn execute_with_options(self, option: RequestOption) -> SDKResult<DeleteAppResponse> {
        ...
        resp.data
            .ok_or_else(|| openlark_core::error::validation_error("app delete", "响应数据为空"))
    }
}
