...
- [ ] **Step 2: 删除 line 3 的 legacy import**
...
- [ ] **Step 3: 删除 `LegacyAppAccessTokenBody` 结构体（line 27-32）**
...
- [ ] **Step 4: 删除 struct 的 3 个 legacy 字段（line 38-40）**
...
- [ ] **Step 5: 从 `new()` 移除 legacy 字段初始化（line 65-67）**
...
- [ ] **Step 6: 删除 3 个 deprecated 方法（line 84-103）**
...
- [ ] **Step 7: 简化 `execute_with_options`（line 111-173）**
...
- [ ] **Step 8: 删除 legacy 测试 `test_execute_legacy_chain_fetches_app_token_then_tenant_token`（line 285-344）**
...
- [ ] **Step 9: 调整 `test_tenant_access_token_builder_new`（line 194-203）**
...
- [ ] **Step 10: 编译验证 openlark-auth crate**
...
- [ ] **Step 4: 三组 feature clippy（default）**
...
- [ ] **Step 5: 三组 feature clippy（all-features）**
...
- [ ] **Step 6: 三组 feature clippy（no-default-features）**
