...
- [ ] **Step 1: 派生 alignment/get 的 Response 字段**
...
- [ ] **Step 2: 派生 alignment/delete 的 Response 字段**
...
- [ ] **Step 1: 派生 cycle/list（GET，enum endpoint）**
...
- [ ] **Step 2: 派生 cycle/objective/list（GET）**
...
- [ ] **Step 3: 派生 cycle/objective/create（POST，body 保留 Value）**
...
- [ ] **Step 4: 派生 cycle/objectives_position（PUT，body 保留 Value）**
