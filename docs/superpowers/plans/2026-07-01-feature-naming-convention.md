...
- [ ] **Step 1: 在 AGENTS.md CONVENTIONS 段追加一行**
...
- [ ] **Step 1: 从 docs-ccm 数组移除 v2/v3 两行**
...
- [ ] **Step 2: 移除 docs-sheets-v2 与 docs-sheets-v3 整个定义**
...
- [ ] **Step 3: 验证无悬空引用、无 sheets-v2/v3 残留**
...
- [ ] **Step 1: cargo fmt --check（CI lint 首步）**
...
- [ ] **Step 5: 核实 docs/FEATURE_MATRIX.md 是否需同步（tasks.md 4.4 / Q3）**
