...
- [ ] **Step 1: 删除 deprecated 别名块（line 12-20）**
...
- [ ] **Step 2: 删除依赖测试块（line 26-36，删除 line 26-36 原 37 行文件中现已是新行号）**
...
- [ ] **Step 1: 三组 feature clippy（default）**
...
- [ ] **Step 2: 三组 feature clippy（--all-features）**
...
- [ ] **Step 3: 三组 feature clippy（--no-default-features）**
...
- [ ] **Step 5: 若任一 clippy/test 失败，加载 systematic-debugging skill**
