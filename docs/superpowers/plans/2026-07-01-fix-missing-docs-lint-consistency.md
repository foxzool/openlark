...
- [ ] **Step 1: 编辑 justfile:14 移除 `-A missing_docs`**
...
- [ ] **Step 1: 删除 security lib.rs:88 的 `#![deny(missing_docs)]`**
...
- [ ] **Step 2: 删除 client lib.rs:238 的死注释**
...
- [ ] **Step 3: 确认 protocol lib.rs:9 的 item 级 allow 保留不动**
...
- [ ] **Step 4: 核心断言——security 移除 deny 后 0 警告**
...
- [ ] **Step 2: cargo doc —— missing_docs warning = 0**
...
- [ ] **Step 3: cargo clippy -p openlark-security —— deny 移除后仍过**

Run: `cargo clippy -p openlark-security --all-features -- -Dwarnings`
Expected: `Finished` + exit 0

- [ ] **Step 4: just lint —— 移除 -A 后与 CI 一致**

Run: `just lint`
Expected: `Finished` + exit 0

- [ ] **Step 5: cargo clippy ndf（CI 同款）**
...
- [ ] **Step 6: cargo build --workspace --all-features**

Run: `cargo build --workspace --all-features`
Expected: `Finished` + exit 0

- [ ] **Step 7: MSRV --locked 验证（pinned lockfile）**
