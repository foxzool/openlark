...
- [ ] **Step 1: 跑 cargo doc 捕获 baseline warning 数**
...
- [ ] **Step 2: 落盘 baseline warning 列表供迁移后 diff**
...
- [ ] **Step 2: 修改 codegen_render.py 包裹 `<URL>`**
...
- [ ] **Step 3: 修改 restructure_hr.py 同形态包裹**
...
- [ ] **Step 2: 核心断言——cargo doc 零 bare_urls**
...
- [ ] **Step 3: cargo doc 总 warning 数（应仅 bare_urls 一种，现在应为 0）**
...
- [ ] **Step 3: 审计非 URL 文本未被误伤（随机抽样 10 文件）**
...
- [ ] **Step 1: 确认 20 业务 crate + 根包均已继承 workspace lints**
...
- [ ] **Step 2: 在根 Cargo.toml 新增 `[workspace.lints.rustdoc]` 段**
...
- [ ] **Step 3: 验证 cargo doc 在 deny 下仍零 warning（lint 升级后通过）**
...
- [ ] **Step 4: 验证 cargo build 接受新 lint 配置**
